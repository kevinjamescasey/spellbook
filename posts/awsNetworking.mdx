...
A summary of different ways to use AWS PrivateLink and Gateway endpoints.
...
- Gateway endpoints require routes to vpce- ID
- The PrivateLink VPC endpoints get a security group and an Elastic Network Interface in each subnet
...
## Providing Ingress Points to Resources

- CloudFront
    - Provides edge caching in Content Deliver Network for regional origin sources
- API Gateway
    - [Edge, Regional, or Private](https://docs.aws.amazon.com/apigateway/latest/developerguide/api-gateway-api-endpoint-types.html)
- AppSync

- Load Balancing
    - Distributes traffic to private hosts in target groups
    - Public or Private
...
- Could create your own ingress point on a public EC2


## Connecting to other networks

- VPN sets up IPsec tunnels
- DirectConect sets up real networks provided by AWS to bypass your usual ISP
...
- Transit Gateway allows [inter-region peering](https://docs.aws.amazon.com/vpc/latest/tgw/tgw-peering.html)
