...
There were probably people before who already recognized many of the aspects of what are now being called Observability and SRE. I think it is important to identify some key characteristics that can help us gain the most value out of this swirl of ideas. There are some fundamental things that are really useful.
