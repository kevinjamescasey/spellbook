---
title: "Popular Containerization and Virtualization Essentials"
...
| container runtime      | software component that container engines delegate container running to                      | runc, containerd, docker engine, incus, cri-o, crun, railcar, katacontainers |
...
![Container Tech Diagram](./containersOnOptionalLayers.jpg)

This shows a few ways to run on the same machine
...
more info about vms and hypervisors
