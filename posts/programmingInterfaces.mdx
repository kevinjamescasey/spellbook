...
It starts with the Don't Repeat Yourself (DRY) principle. Programmers want to write generic code that can be resused in many different ways. If you break it down into operations and data, there are a couple strategies to help achieve DRYness.
...
## Other polymorphic didpatch techniques
