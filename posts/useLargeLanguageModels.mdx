...
How about [TensorFlow Serving](https://www.tensorflow.org/tfx/guide/serving), [TorchServe](https://pytorch.org/serve/), or [ExecuTorch](https://github.com/pytorch/executorch) 
