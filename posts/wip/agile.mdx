...
How do you know if investing in improving efficiency is worth it? It depends on the timelines and goals.

Even after communicating, people never share the exact same perspective on anything. They have different ideas about the scope andy priority of the intended work. Different people focus on different aspects of a problem and different tasks intended to help solve the problem. Nobody fully understand all of the details of the problem and all of the details of the potential solutions. Conversations always end with everyone involved having an incomplete understanding of the others' perspective. When something tangible is created it provides a means to share perspective in future conversations. If something made appears to be a possible component of the whole solution, it can change the mind of someone who envisioned a different solution. A working component is often more persuasive than any description of a part of a solution.