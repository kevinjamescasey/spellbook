...
+ entropy
  ...
  - die roll unveils more certainty than a coin flip because each possible state in a die roll is less certain than those in a coin flip
    - lower probability events convey more information when they occur
...
This seems related to measuring the amount of information as is done in Information Theory
...
- The "learning" part of ML is recording some representation of samples observed but not necessarily keeping all information
